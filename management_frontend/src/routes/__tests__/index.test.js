...
describe('route: /', function() {
    ...
    it('should render fine without any router passed params', function() {
        index.__set__('rp', mock.rp);
        index.__set__('Data', mock.Data);

        var page = ReactTestUtils.renderIntoDocument(<IndexHandler />);
    ...
    describe('ChangesColumn', function() {
        var ChangesColumn;

        beforeEach(function() {
            ChangesColumn = index.__get__('ChangesColumn');
        });
        ...
        it('should map changes from Data.changes.getWeek to <DefaultChange />s', function() {
            ...
            index.__set__('DefaultChange', DefaultChange);
